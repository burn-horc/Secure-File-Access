...
import logo from "@assets/phcorner_logo.png";
        ...
        >
          ...
          <Box px={4} pb={4}>
            <Button
              ...
              color={copiedStates[`${index}-details`] ? theme.accent : "rgba(255,255,255,0.65)"}
              borderRadius="10px"
              fontSize="sm"
              w="full"
              _hover={{ borderColor: theme.border, color: theme.accent }}
              onClick={() => handleCopyWithFeedback(`${index}-details`, () => handleCopyDetails(result))}
              data-testid={`button-copy-details-${index}`}
            >
              {copiedStates[`${index}-details`] ? "✓ Details Copied!" : "📋 COPY COMPLETE DETAILS"}
            </Button>
          </Box>
        </Box>
      );
