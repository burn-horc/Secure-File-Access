 ...
 {isFetchingAccount && (
      ...
      >
        <Box
          ...
          borderRadius="20px"
          borderWidth="1px"
          borderColor={isPremiumPage ? "rgba(139,92,246,0.28)" : "rgba(56,189,248,0.28)"}
          bg="linear-gradient(160deg, #181e35 0%, #0f1220 100%)"
          boxShadow="0 0 0 1px rgba(139,92,246,0.08), 0 20px 60px rgba(0,0,0,0.9)"
          p={6}
          textAlign="center"
        >
          <Box
            ...
            borderTop={isPremiumPage ? "4px solid #8b5cf6" : "4px solid #38bdf8"}
            borderRadius="50%"
          ...
          <Text
            fontSize="lg"
            fontWeight="800"
            color={isPremiumPage ? "#c4b5fd" : "#38bdf8"}
            letterSpacing="0.1em"
            textTransform="uppercase"
            mb={2}
          >
            {isPremiumPage ? "🔍 Finding Valid NETFLIX Account" : "🔍 FINDING PREMIUM"}
          </Text>
          <Text
            fontSize="sm"
